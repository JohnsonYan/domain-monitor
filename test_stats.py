...
class Stats(object):
    def __init__(self):
        ...
        # mongodb config
        self.domain = pymongo.MongoClient('localhost', 27017)['virustotal']['test_domain']
        self.report = pymongo.MongoClient('localhost', 27017)['virustotal']['test_report']
        self.ddns = pymongo.MongoClient('localhost', 27017)['virustotal']['test_ddns']
        # report document
        self.daily_report = {}
